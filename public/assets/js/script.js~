...
$('#submit_button').click(function(e){ 
	...
	var report = $('#beneficiary').val();
	var indus = $('#kid_amount').val();
	var sales = $('#zip_code').val();
	var proposal = $('#proposal').val();
	$.ajax({
		    type: "POST",
		    url: 'http://localhost/orderdata', 
		    data: { id: report,indus:indus,sales:sales,proposal:proposal },
